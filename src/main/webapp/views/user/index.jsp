        ...
        <div class="row mb-4">
            ...
            <div class="col-6 d-flex justify-content-end align-items-center">
                <form action="" class="tm-text-primary">
				    Page <input type="text" value="${currentPage}" size="1" class="tm-input-paging tm-text-primary"> of ${maxPage}
				</form>
            </div>
        </div>
...
<script >
	$('#changePassBtn').click(function() {
		...
		$.ajax({
			...
			$('#messageChanePass').text('Your password has been changed successfull');
		}).fail(function (error) {
			$('#messageChanePass').text('Your password is not correct, try again');
		});
	});
</script>