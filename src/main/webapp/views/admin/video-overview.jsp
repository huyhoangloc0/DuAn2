	...
	<div class="wrapper">
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<a href="index3.html" class="brand-link"> <img
				...
				class="brand-text font-weight-light">Youtube</span>
			</a>
			...
			<div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
						...
						<li class="nav-item menu-open"><a href="<c:url value='/admin/video?action=view'/>" class="nav-link active">
							...
							<tbody>
							    <c:forEach var="item" items="${videos}">
							        <tr>
							            ...
							            <td><a href="<c:url value='/video?action=watch=watch&id=${item.href}'/>">${item.href}</a></td>
							            <td>
    ...
    <script>
    	function deleteVideo(href) {
			$.ajax({
				...
				window.location.href = "http://localhost:8081/asm-java4/admin/video?action=view";
			}).fail(function(error) {
